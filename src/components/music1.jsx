...
const Music1 = ({video, idx}) => {
  return (
    <div className="music1-music">
      <Link to={video?.videoId ? `/video/${video?.videoId}` : null } type="button" className="button music-line music1-line">
        ...
        <span className="music1-text04">
          <span >{ video?.title ? video?.title : null}</span>
          <br></br>
        </span>
        ...
        <span className="music1-text07">{video?.viewCount}</span>
