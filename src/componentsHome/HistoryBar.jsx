...
const HistoryBar = (props)=>{
    return(
        <section className="home-history"style={{display: 'flex'}}>
          <span className="home-text29 text">Last Playlist</span>
          <div className="home-share2 posibili buttonChange">
          ...
          <div className="home-play-list06 posibili buttonChange">
          ...
          <div className="home-like2 posibili buttonChange">
