...
import { ApiYouTube9, ApiYouTube10, ApiYouTube12, ApiSpotify3, ApiShazam1, ApiDataBaseGet, ApiYouTube3, ApiAllPlatforms } from '../utils/fetchAPI'
...
const Home = () => {
  ...
  const [buttonYoutube, setButtonYoutube] = React.useState(false);
  const [buttonSpotify, setButtonSpotify] = React.useState(false);
  const [buttonAppleMusic, setButtonAppleMusic] = React.useState(false);
    ...
    <div className="home-container">
      ...
      <div className="home-up up">
        ...
        <div className="home-posibili posibili">
          <button id="youtube" disabled={buttonYoutube} className="home-button button account" onClick={() => {setType('youtube');
          ...
          <button id="spotify" disabled={buttonSpotify} className="home-button button account" onClick={() => {setType('spotify');
          ...
          <button id="appleMusic" disabled={buttonAppleMusic} className="home-button button account" onClick={() => {setType('appleMusic');
      ...
      <div className="home-view content">
        <section className="home-left-bar">
          ...
          <Link to={`/history`} id="history" className="home-button05 navbar button account" onClick={()=>{
                          setStatusHomeButton(false);
                          setStatusTredingButton(false);
                          setStatusFavoriteButton(false);
                          setStatusPlayListButton(false);
          ...
          <Link to={`/send`} id="send" className="home-button11 navbar button account"onClick={()=>{
            ...
            {statusHomeButton? (<>
                                {styleChange('youtube')}
                                {styleChange('spotify')}
                                {styleChange('appleMusic')}
                                <HomeBar token={token} mood={mood} idSp={idSp} setButtonYoutube={setButtonYoutube}
                      setButtonSpotify={setButtonSpotify} setButtonAppleMusic={setButtonAppleMusic}></HomeBar>
                              </>) : null}
            {statusTredingButton? (<>
                                ...
                                <TredingBar trending={trending} token={token} mood={mood} idSp={idSp} setButtonYoutube={setButtonYoutube}
                      setButtonSpotify={setButtonSpotify} setButtonAppleMusic={setButtonAppleMusic}></TredingBar>
                              </>) : null}
            {statusFavoriteButton?  (<>
                                {styleChange('youtube')}
                                {styleChange('spotify')}
                                {styleChange('appleMusic')}
                                <FavoriteBar mood={mood} idSp={idSp} userDate={userDate} setButtonYoutube={setButtonYoutube}
                      setButtonSpotify={setButtonSpotify} setButtonAppleMusic={setButtonAppleMusic}></FavoriteBar> 
                              </>) : null}
            {statusPlayListButton? (<>
                                {styleChange('youtube')}
                                {styleChange('spotify')}
                                {styleChange('appleMusic')}
                                <PlayListBar mood={mood} idSp={idSp} userDate={userDate} setButtonYoutube={setButtonYoutube}
                      setButtonSpotify={setButtonSpotify} setButtonAppleMusic={setButtonAppleMusic}></PlayListBar>
                              </>) : null}
            {statusHistoryButton ? (<>
                                {styleChange('youtube')}
                                {styleChange('spotify')}
            ...
            {statusSendButton? (<>
                                ...
                                {mood !== 'spotify' ? styleChangeOfBar('spotify') : null}
                                {mood !== 'appleMusic' ? styleChangeOfBar('appleMusic') : null}
                                <SendBar mood={mood} idSp={idSp} userDate={userDate} setButtonYoutube={setButtonYoutube} 
                        setButtonSpotify={setButtonSpotify} setButtonAppleMusic={setButtonAppleMusic}></SendBar>
                            </>):null}
            {statusFiltreButton? (<>
                                {mood !== 'youtube' ? styleChangeOfBar('youtube') : null}
                                {mood !== 'spotify' ? styleChangeOfBar('spotify') : null}
                                {mood !== 'appleMusic' ? styleChangeOfBar('appleMusic') : null}
                                <FiltreBar selectedFiltre={selectedFiltre} idSp={idSp} setStatusSearchButtons={setStatusSearchButtons} 
                        setStatusFiltreButtons={setStatusFiltreButtons} setSelectedFiltre={setSelectedFiltre}setButtonYoutube={setButtonYoutube} 
                        setButtonSpotify={setButtonSpotify} setButtonAppleMusic={setButtonAppleMusic}></FiltreBar>
                            </>):null}
            {statusSearcheButton? (<>
                                {mood !== 'youtube' ? styleChangeOfBar('youtube') : null}
                                {mood !== 'spotify' ? styleChangeOfBar('spotify') : null}
                                {mood !== 'appleMusic' ? styleChangeOfBar('appleMusic') : null}
                                <SearchBar idSp={idSp} selectedFiltre={selectedFiltre} mood={mood} setButtonYoutube={setButtonYoutube} 
